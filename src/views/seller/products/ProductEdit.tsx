...
import { useAddProductMutation, useFetchProductMutation } from "@/store/Reducers/productApiSlice";
...
function ProductEdit() {
  ...
  useEffect(() =>{
    form.setValue("media",files) ; console.log(filesUrls) ;
    if(filesUrls[0])
